...
var ListaDoble = /** @class */ (function () {
    ...
    // insertar al inicio
    ListaDoble.prototype.beginInsert = function (data) {
    ...
    // insertar al final
    ListaDoble.prototype.lastInsert = function (data) {
        var nuevo = new Nodo(data);
        if (this.tail === null) {
            this.head = nuevo;
            this.tail = nuevo;
    ...
    ListaDoble.prototype.randomInsert = function (pos, data) {
        if (this.head === null) {
            if (pos === -1 || pos === 0) {
                var nuevo_1 = new Nodo(data);
                this.head = nuevo_1;
                this.tail = nuevo_1;
    ...
    // eliminar al inicio
    ListaDoble.prototype.beginDelete = function () {
        if (this.head === null) {
    ...
    // eliminar al final
    ListaDoble.prototype.lastDelete = function () {
        if (this.tail === null) {
            console.log("La lista está vacía");
            return;
        }
    ...
    ListaDoble.prototype.randomDelete = function (pos) {
        if (this.head === null) {
            console.log("La lista está vacía");
            return;
        }
    ...
    ListaDoble.prototype.displayForward = function () {
        if (this.head === null) {
            console.log("La lista está vacía");
            return;
        }
    ...
    ListaDoble.prototype.displayBackward = function () {
        if (this.tail === null) {
            console.log("La lista está vacía");
            return;
        }
...
do {
    ...
    switch (opcion) {
        ...
        case 2:
            ...
            break;
        case 3:
            lista.randomInsert(parseInt(prompt("Posición después de la cual insertar: ") || "0"), parseInt(prompt("Dato a insertar: ") || "0"));
            break;
        case 4:
            lista.beginDelete();
            break;
